...
/******/
/******/ 		// Check if module is in cacheshowAlert
...
module.exports = {
	...
	methods: {
		...
		//预下单，payType支付类型，reference商户流水号
		prepay: function prepay(payType, reference) {

			payPlugin.prepay({
            				 merchantNo:'200043',
            				 storeNo:'300014',
            				 token:'4dc2f2281d1f51fe137eafb914106524',
            				 payType:payType,//1支付宝2微信
            				 amount:0.01,
			...
			function (result) {
				modal.toast({
					message: '支付结果：' + result.payType +"," + result.retCode+"," +result.retMsg,
					duration: 4.0 });
		...
		//查询订单，reference商户流水号
		queryOrder: function queryOrder(reference) {
		    payPlugin.queryOrder({
                        	  merchantNo:'200043',
                        	  storeNo:'300014',
                        	  token:'4dc2f2281d1f51fe137eafb914106524',
                        	  reference: reference},
		...
		//退款，reference商户流水号
        refund: function refund(amount, reference) {
            payPlugin.refund({
                              merchantNo:'200043',
                              storeNo:'300014',
                              token:'4dc2f2281d1f51fe137eafb914106524',
